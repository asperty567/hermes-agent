...
from agent.prompt_builder import build_skills_system_prompt, build_context_files_prompt, build_environment_hints, build_obsidian_memory_prompt, load_soul_md, TOOL_USE_ENFORCEMENT_GUIDANCE, TOOL_USE_ENFORCEMENT_MODELS, GOOGLE_MODEL_OPERATIONAL_GUIDANCE, OPENAI_MODEL_EXECUTION_GUIDANCE
...
class AIAgent:
    ...
    def _build_system_prompt_parts(self, system_message: str = None) -> Dict[str, str]:
        ...
        if not getattr(self, "skip_memory", False):
            obsidian_memory_prompt = build_obsidian_memory_prompt()
            if obsidian_memory_prompt:
                context_parts.append(obsidian_memory_prompt)
